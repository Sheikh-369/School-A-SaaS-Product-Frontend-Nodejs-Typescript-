  ...
  <div className="w-full max-w-[1200px] bg-[#13131a] rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
    ...
    <div className="w-full md:w-1/2 p-6 md:p-12">
      <div className="max-w-md mx-auto">
        <h1 className="text-white text-2xl md:text-4xl font-semibold mb-2">User Login</h1>
        <p className="text-gray-400 mb-8">
          Forgot password?
          <a href="https://abhirajk.vercel.app/" className="text-white hover:underline">forgot-password</a>
        </p>
